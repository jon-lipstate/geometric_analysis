...
impl PGA3D {
    ...
    pub fn pt_to_cartesian(&self) -> &Vec<float_t> {
        &self.mvec
    }
...
fn main() {
    ...
    // let a = pga2d::PGA2D::point_euclidean(-1.0, -1.0);
    // let c = pga2d::PGA2D::point_euclidean(1.0, 1.0);
    // let m = c.clone() & a.clone();
    // println!("a      {:?}", a.mvec);
    // // println!("{:?}", c.mvec);
    // // println!("{:?}", m.mvec);
    // let mut d = pga2d::PGA2D::zero();
    // d.set_value(pga2d::Blade::e0, 1.0);
    // d.set_value(pga2d::Blade::e1, -1.0); //x
    // d.set_value(pga2d::Blade::e2, -1.0); //y
    // let d_dual = d.dual();
    // println!("d_dual {:?}", d_dual.mvec);
    // let dd_dual = d_dual.dual();
    // println!("dd_dual {:?}", dd_dual.mvec);
    use pga2d::Blade;
    let blades = vec![
        Blade::one,
        Blade::e0,
    ...
    // let clones = blades.clone();
    // for &blade in &blades {
    //     for &clone in &clones {
    //         let res = &blade.cayley_str(&clone);
    //         println!("{}", res);
    //     }
    // }
    println!("{}", &Blade::e0.dual_str());
    println!("{}", &Blade::e1.dual_str());
    println!("{}", &Blade::e2.dual_str());
    println!("{}", &Blade::e012.dual_str());
}
